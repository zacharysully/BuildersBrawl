...
public class PlayerSelect : MonoBehaviour
{
    ...
    public void SelectPlayerOne(int controllerNum)
    {
        ...
        if(!playerOneSelected)
        {
            ...
            AssignNextPlayer(controllerNum);
        }
    }

    public void SelectPlayerTwo(int controllerNum)
    {
    ...
    public void SelectPlayerThree(int controllerNum)
    {
        //Selects player two if not previously done and if player one was already selected
    ...
    public void SelectPlayerFour(int controllerNum)
    {
        //Selects player two if not previously done and if player one was already selected
    ...
    public void AssignNextPlayer(int rewiredPlayerId)
    {
        ...
        //print("MAP ADD " + "ReNum: " + rewiredPlayerId.ToString() + "GameNum " + gamePlayerId.ToString());
        //if(playerMap.Contains())
    ...
    private void InitializeScene()
    {
        if (!initialized)
        {
            ...
            if (RoundsManager.R.round == 1)
            {
                ...
                //print("MAP RESET");
                //reset map lits
                //playerMap = new List<PlayerMap>();              //this would somehow break it
